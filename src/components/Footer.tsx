      ...
      <div className="container px-4 sm:px-6 mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8 sm:mb-12">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="text-xl sm:text-2xl font-bold font-serif text-primary mb-3 sm:mb-4 inline-block">
              NEXUS
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#reservation" className="text-sm sm:text-base hover:text-primary transition-colors">
                  Reservations
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row">
              <input
                ...
                className="px-3 sm:px-4 py-2 rounded-md sm:rounded-l-md sm:rounded-r-none w-full focus:outline-none text-secondary mb-2 sm:mb-0 text-sm sm:text-base"
              />
              <button
                type="submit"
                className="bg-primary text-white px-3 sm:px-4 py-2 rounded-md sm:rounded-l-none sm:rounded-r-md hover:bg-opacity-90 transition-colors text-sm sm:text-base"
              >
                Subscribe
              </button>
            </form>
        ...
        {/* Copyright */}
        <div className="pt-6 sm:pt-8 border-t border-gray-700 text-center text-sm sm:text-base">
          <p>&copy; {currentYear} NEXUS Restaurant. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
